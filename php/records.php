                ...
                <div class="card-container">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-subtitle">3rd Year</p>
                            <hr />
                            <div class="card-due">
                                <span class="due-label">Due</span>
                                <span class="due-date">May 30, 2024</span>
                            </div>
                            <button
                                class="view-details"
                                data-bs-toggle="modal"
...
>
    <div
        class="modal-dialog modal-dialog-centered detail-modal"
        role="document"
    >
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-tag" id="detailsModalLabel">
                    <img src="../png/user.png" alt="Avatar" class="avatar-student " />
                    Marvin Cayosa
                </h2>
            </div>
